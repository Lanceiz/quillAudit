  ...
  return (
    <section className="self-stretch [background:linear-gradient(89.44deg,_#edf2fe,_rgba(217,_217,_217,_0))] flex flex-row items-end justify-center pt-12 pb-[47px] pr-[402.6000000000003px] pl-[403px] box-border gap-[103px] max-w-full text-left text-3xl text-royalblue-100 font-wf-body-body-medium mq850:gap-[26px] mq850:py-[31px] mq850:px-[100px] mq850:box-border mq1225:gap-[51px] mq1225:pl-[201px] mq1225:pr-[201px] mq1225:box-border mq1525:flex-wrap">
      ...
      <div className="w-[439px] flex flex-col items-start justify-start pt-0 px-0 pb-[38px] box-border min-w-[439px] max-w-full mq1525:flex-1 mq1525:min-w-full">
        <div className="self-stretch flex flex-col items-start justify-start gap-[30px_0px] max-w-full">
          <b className="relative tracking-[-0.01em] leading-[160%] z-[1] mq450:text-lg mq450:leading-[28px]">
            NEWSLETTER
          </b>
          <div className="self-stretch flex flex-col items-start justify-start gap-[42px_0px] max-w-full text-29xl text-darkslateblue font-jost mq450:gap-[21px_0px]">
            ...
            <div className="w-[364px] relative text-base tracking-[-0.01em] leading-[150%] font-wf-body-body-medium text-wf-base-800 whitespace-pre-wrap inline-block max-w-full z-[1]">
      ...
      <div className="flex-1 flex flex-col items-start justify-start gap-[8.5px_0px] min-w-[376px] max-w-full text-2xl-3 text-mediumslateblue-200 font-open-sans mq1225:min-w-full">
        <div className="self-stretch flex flex-row items-start justify-start max-w-full">
          <div className="w-[548.2px] flex flex-col items-start justify-start pt-[14.400000000000093px] px-0 pb-0 box-border max-w-full">
            <div className="self-stretch flex flex-row items-end justify-start pt-[86.89999999999986px] pb-0 pr-[52px] pl-[88.89999999999964px] relative gap-[0px_29.3px] mq450:pl-5 mq450:box-border mq850:flex-wrap mq850:pl-11 mq850:pr-[26px] mq850:box-border">
              <img
                className="h-[315px] w-full absolute !m-[0] top-[0px] right-[0px] left-[0px] max-w-full overflow-hidden z-[1]"
                alt=""
                src="/group.svg"
              />
              ...
              <div className="h-[210.8px] w-[164.9px] relative min-w-[164.89999999999964px] mq850:flex-1">
                <img
          ...
          <div className="h-[270.4px] flex-1 flex flex-col items-start justify-end pt-[191.4000000000001px] pb-[32.299999999999955px] pr-[148.5px] pl-[347px] box-border relative gap-[6.1px_0px] max-w-full ml-[-548.2px] mq450:pl-5 mq450:pr-5 mq450:box-border mq850:pl-[173px] mq850:pr-[74px] mq850:box-border">
            ...
            <div className="flex-1 flex flex-row items-start justify-start py-0 px-[7px]">
              <div className="h-[15.3px] flex flex-row items-start justify-start relative">
                <img
                  className="h-[22.8px] w-[76.9px] absolute !m-[0] right-[-13.4px] bottom-[-5.1px] z-[6]"
                  alt=""
                />
                <div className="relative font-extrabold z-[7] mq450:text-mid">
                  MAIL
                </div>
              </div>
            </div>
            <img
              className="w-full h-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px] max-w-full overflow-hidden max-h-full z-[8]"
              alt=""
              src="/group-6.svg"
            />
          </div>
        ...
        <div className="self-stretch flex flex-row items-start justify-start py-0 px-[39px] box-border max-w-full text-base text-gray-100 font-jost">
          <div className="flex-1 rounded-md bg-white shadow-[2px_2px_12px_rgba(0,_0,_0,_0.06)] flex flex-row items-end justify-between py-2 pr-2 pl-4 box-border max-w-full gap-[20px] z-[1] mq850:flex-wrap">
            ...
            <button className="cursor-pointer [border:none] py-1.5 px-[22px] bg-[transparent] rounded [background:linear-gradient(264.69deg,_#7184fd_20%,_#3f7af0_50%,_#4f37ee)] shadow-[0px_1px_2px_rgba(0,_0,_0,_0.05)] flex flex-row items-start justify-start z-[1]">
              <div className="relative text-base leading-[24px] font-medium font-jost text-white text-left">
                Subscribe
              </div>
            </button>
          </div>
