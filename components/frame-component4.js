const FrameComponent4 = () => {
  return (
    <section className="self-stretch flex flex-row items-start justify-center pt-0 px-5 pb-[63.5px] box-border max-w-full text-left text-xl text-gray-300 font-wf-body-body-medium mq450:pb-[41px] mq450:box-border">
      <div className="w-[862.5px] flex flex-row flex-wrap items-start justify-center gap-[0px_61px] max-w-full mq450:gap-[0px_15px] mq1225:gap-[0px_30px]">
        <div className="flex-1 flex flex-col items-start justify-start gap-[24px_0px] min-w-[240px] max-w-full">
        ...
        <div className="flex-1 flex flex-col items-start justify-start pt-px px-0 pb-0 box-border min-w-[240px] max-w-full">
          <div className="self-stretch flex flex-col items-start justify-start gap-[56px_0px] max-w-full mq450:gap-[28px_0px]">
            <div className="self-stretch flex flex-col items-start justify-start gap-[24.5px_0px] max-w-full">
