const FrameComponent3 = () => {
  return (
    <section className="self-stretch flex flex-row items-start justify-center pt-0 px-5 pb-[40.8px] box-border max-w-full text-left text-lg text-gray-300 font-poppins mq1225:pb-5 mq1225:box-border">
      <div className="w-[1140px] flex flex-col items-start justify-start gap-[40px_0px] max-w-full shrink-0 mq850:gap-[20px_0px]">
        <div className="self-stretch flex flex-row items-start justify-start gap-[0px_40px] max-w-full mq850:gap-[0px_20px] mq1225:flex-wrap">
          <div className="flex-1 flex flex-col items-start justify-start gap-[40.25px_0px] max-w-full mq850:gap-[20px_0px] mq850:min-w-full">
          ...
          <div className="w-[342px] flex flex-col items-start justify-start pt-[58px] px-0 pb-0 box-border min-w-[342px] max-w-full text-sm text-gray-200 font-wf-body-body-medium mq450:min-w-full mq1225:flex-1">
            <div className="self-stretch rounded-md bg-gray-600 shadow-[0px_3px_12px_1px_rgba(85,_128,_219,_0.21)] overflow-hidden flex flex-col items-start justify-start pt-2.5 px-[30px] pb-[30px] gap-[19.5px_0px] border-[1px] border-solid border-color-palette-1-quill-scheme3">
              <div className="w-[137px] flex flex-col items-start justify-start gap-[0.5px_0px]">
                <div className="relative leading-[21px]">Headquarters</div>
