const FrameComponent5 = () => {
  return (
    <section className="w-full h-[802px] absolute !m-[0] top-[0px] right-[0px] left-[0px]">
      ...
      />
      <img
        className="absolute top-[48.1px] left-[583.4px] w-[16.1px] h-[9.4px] z-[1]"
        loading="lazy"
        alt=""
        src="/arrow.svg"
      />
      <img
        className="absolute top-[48.1px] left-[976.6px] w-[16.1px] h-[9.4px] z-[1]"
        alt=""
        src="/arrow-1.svg"
      />
      <img
        className="absolute top-[48.1px] left-[1146.6px] w-[16.1px] h-[9.4px] z-[1]"
        alt=""
        src="/arrow-2.svg"
      />
      <img
        className="absolute top-[40.1px] left-[225.9px] w-[158px] h-[21.4px] z-[1]"
        loading="lazy"
        alt=""
        src="/quillaudits.svg"
      />
      <img
        className="absolute top-[29.4px] left-[167px] w-[45.5px] h-[42.8px] z-[1]"
        loading="lazy"
        alt=""
        src="/icon.svg"
      />
